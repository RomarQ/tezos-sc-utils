...
class Contract(sp.Contract):
  ...
  def test(self):
    ...
    sp.for utils_35_x in sp.list([1, 2, 3, 4, 5]):
      ...
      sp.else:
        utils_34_hist.value[utils_35_x] = 1
    compute_utils_90i = sp.local("compute_utils_90i", sp.len(sp.list([1, 2, 3, 4, 5])))
    utils_36_result = sp.local("utils_36_result", 0)
    utils_37_half = sp.local("utils_37_half", compute_utils_90i.value // 2)
    utils_38_use_average = sp.local("utils_38_use_average", (utils_37_half.value * 2) == compute_utils_90i.value)
    ...
    sp.for utils_42_x in sp.list([1, 2, 2, 3]):
      ...
      sp.else:
        utils_41_hist.value[utils_42_x] = 1
    compute_utils_90 = sp.local("compute_utils_90", sp.len(sp.list([1, 2, 2, 3])))
    utils_43_result = sp.local("utils_43_result", 0)
    utils_44_half = sp.local("utils_44_half", compute_utils_90.value // 2)
    utils_45_use_average = sp.local("utils_45_use_average", (utils_44_half.value * 2) == compute_utils_90.value)
  ...
  def math_median(_x1):
    ...
    sp.for utils_4_x in _x1:
      ...
      sp.else:
        utils_3_hist.value[utils_4_x] = 1
    compute_utils_90 = sp.local("compute_utils_90", sp.len(_x1))
    utils_5_result = sp.local("utils_5_result", 0)
    utils_6_half = sp.local("utils_6_half", compute_utils_90.value // 2)
    utils_7_use_average = sp.local("utils_7_use_average", (utils_6_half.value * 2) == compute_utils_90.value)
