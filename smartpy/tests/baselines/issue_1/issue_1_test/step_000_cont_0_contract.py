...
class Contract(sp.Contract):
  ...
  def test(self):
    ...
    sp.for utils_2 in sp.range(0, utils_0.value):
      compute_utils_342 = sp.local("compute_utils_342", sp.slice(sp.bytes('0xff'), utils_2, 1).open_some(message = sp.unit))
    ...
    sp.for utils_5 in sp.range(0, utils_3.value):
      compute_utils_342 = sp.local("compute_utils_342", sp.slice(sp.bytes('0xffff'), utils_5, 1).open_some(message = sp.unit))
      compute_utils_343 = sp.local("compute_utils_343", sp.as_nat(utils_3.value - (utils_5 + 1)) * 2)
